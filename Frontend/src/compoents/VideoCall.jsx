...
export default function VideoCall({ onToggleChat }) {
  ...
  return (
    <div className="flex-1 bg-gray-900 relative">
      {/* Header */}
      <div className="absolute top-0 left-0 right-0 bg-white p-4 flex items-center justify-between z-10">
      ...
      <div className="h-full pt-16 pb-20 px-4 flex items-center justify-center">
        <div className="relative w-full max-w-2xl h-full bg-gray-800 rounded-lg overflow-hidden">
          <img
            src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=150&fit=crop&crop=face"
            alt="Dr. Taylor"
